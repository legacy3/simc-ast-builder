 ...
 */
export class ConditionOptimizerZ3 {
  private options: OptimizerOptions;

  /**
   * Create a new ConditionOptimizerZ3
  ...
  private astToZ3(
    node: ExpressionNode,
    ctx: InstanceType<ReturnType<typeof getContextType>>,
  ): any {
...
// Helper for type inference (not used at runtime)
function getContextType() {
  return new (class {})() as any;
}
