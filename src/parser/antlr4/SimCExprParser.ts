...
export class SimCExprParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		"parse", "commentLine", "actionLine", "actionParam", "identifier", "actionName", 
		"sublistName", "accessPattern", "expression",
	];
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(SimCExprParser._LITERAL_NAMES, SimCExprParser._SYMBOLIC_NAMES, []);
	...
	// @Override
	public get ruleNames(): string[] { return SimCExprParser.ruleNames; }

	// @Override
	public get serializedATN(): string { return SimCExprParser._serializedATN; }
	...
	public actionParam(): ActionParamContext {
		let _localctx: ActionParamContext = new ActionParamContext(this._ctx, this.state);
	...
	public identifier(): IdentifierContext {
		...
		try {
			...
			this.state = 52;
			_la = this._input.LA(1);
			if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SimCExprParser.NUMBER) | (1 << SimCExprParser.MIXED_ID) | (1 << SimCExprParser.STRING))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public actionName(): ActionNameContext {
		let _localctx: ActionNameContext = new ActionNameContext(this._ctx, this.state);
	...
	public sublistName(): SublistNameContext {
		let _localctx: SublistNameContext = new SublistNameContext(this._ctx, this.state);
	...
	public accessPattern(): AccessPatternContext {
		let _localctx: AccessPatternContext = new AccessPatternContext(this._ctx, this.state);
	...
	public expression(_p?: number): ExpressionContext {
		...
		try {
			...
			case 2:
				...
				this.state = 71;
				_la = this._input.LA(1);
				if (!(_la === SimCExprParser.OP_CEIL || _la === SimCExprParser.OP_FLOOR)) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
			...
			case 3:
				...
				this.state = 76;
				_la = this._input.LA(1);
				if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SimCExprParser.OP_NOT) | (1 << SimCExprParser.OP_PLUS) | (1 << SimCExprParser.OP_MINUS) | (1 << SimCExprParser.OP_ABS))) !== 0))) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.state = 86;
						_la = this._input.LA(1);
						if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SimCExprParser.OP_MUL) | (1 << SimCExprParser.OP_DIV) | (1 << SimCExprParser.OP_MOD))) !== 0))) {
						this._errHandler.recoverInline(this);
						} else {
							if (this._input.LA(1) === Token.EOF) {
								this.matchedEOF = true;
					...
					case 2:
						...
						this.state = 89;
						_la = this._input.LA(1);
						if (!(_la === SimCExprParser.OP_PLUS || _la === SimCExprParser.OP_MINUS)) {
						this._errHandler.recoverInline(this);
						} else {
							if (this._input.LA(1) === Token.EOF) {
								this.matchedEOF = true;
					...
					case 3:
						...
						this.state = 92;
						_la = this._input.LA(1);
						if (!(_la === SimCExprParser.OP_MAX || _la === SimCExprParser.OP_MIN)) {
						this._errHandler.recoverInline(this);
						} else {
							if (this._input.LA(1) === Token.EOF) {
								this.matchedEOF = true;
					...
					case 4:
						...
						this.state = 95;
						_la = this._input.LA(1);
						if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SimCExprParser.OP_GT) | (1 << SimCExprParser.OP_GE) | (1 << SimCExprParser.OP_LT) | (1 << SimCExprParser.OP_LE) | (1 << SimCExprParser.OP_EQ) | (1 << SimCExprParser.OP_EQEQ) | (1 << SimCExprParser.OP_NE))) !== 0))) {
						this._errHandler.recoverInline(this);
						} else {
							if (this._input.LA(1) === Token.EOF) {
								this.matchedEOF = true;
	...
	public static get _ATN(): ATN {
		if (!SimCExprParser.__ATN) {
			SimCExprParser.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(SimCExprParser._serializedATN));
		}
...
export class ParseContext extends ParserRuleContext {
	...
	public EOF(): TerminalNode { return this.getToken(SimCExprParser.EOF, 0); }
	...
	// @Override
	public get ruleIndex(): number { return SimCExprParser.RULE_parse; }
	// @Override
...
export class CommentLineContext extends ParserRuleContext {
	public COMMENT(): TerminalNode { return this.getToken(SimCExprParser.COMMENT, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SimCExprParser.RULE_commentLine; }
	// @Override
	public enterRule(listener: SimCExprListener): void {
...
export class ActionLineContext extends ParserRuleContext {
	...
	public OP_EQ(): TerminalNode { return this.getToken(SimCExprParser.OP_EQ, 0); }
	...
	// @Override
	public get ruleIndex(): number { return SimCExprParser.RULE_actionLine; }
	// @Override
	public enterRule(listener: SimCExprListener): void {
...
export class ActionParamContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SimCExprParser.RULE_actionParam; }
	// @Override
	public enterRule(listener: SimCExprListener): void {
...
export class IdentifierContext extends ParserRuleContext {
	public NUMBER(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.NUMBER, 0); }
	public STRING(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.STRING, 0); }
	public MIXED_ID(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.MIXED_ID, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SimCExprParser.RULE_identifier; }
	// @Override
	public enterRule(listener: SimCExprListener): void {
...
export class ActionNameContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SimCExprParser.RULE_actionName; }
	// @Override
	public enterRule(listener: SimCExprListener): void {
...
export class SublistNameContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SimCExprParser.RULE_sublistName; }
	// @Override
	public enterRule(listener: SimCExprListener): void {
...
export class AccessPatternContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SimCExprParser.RULE_accessPattern; }
	// @Override
	public enterRule(listener: SimCExprListener): void {
...
export class ExpressionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SimCExprParser.RULE_expression; }
	public copyFrom(ctx: ExpressionContext): void {
		super.copyFrom(ctx);
	}
}
export class ParenExprContext extends ExpressionContext {
	public OP_PAREN_LEFT(): TerminalNode { return this.getToken(SimCExprParser.OP_PAREN_LEFT, 0); }
	public expression(): ExpressionContext {
		return this.getRuleContext(0, ExpressionContext);
	}
	public OP_PAREN_RIGHT(): TerminalNode { return this.getToken(SimCExprParser.OP_PAREN_RIGHT, 0); }
...
export class MathFuncExprContext extends ExpressionContext {
	...
	public OP_PAREN_RIGHT(): TerminalNode { return this.getToken(SimCExprParser.OP_PAREN_RIGHT, 0); }
	public OP_CEIL(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_CEIL, 0); }
	public OP_FLOOR(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_FLOOR, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class UnaryExprContext extends ExpressionContext {
	...
	public OP_NOT(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_NOT, 0); }
	public OP_PLUS(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_PLUS, 0); }
	public OP_MINUS(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_MINUS, 0); }
	public OP_ABS(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_ABS, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class MultiplicativeExprContext extends ExpressionContext {
	...
	public OP_MUL(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_MUL, 0); }
	public OP_DIV(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_DIV, 0); }
	public OP_MOD(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_MOD, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class MinMaxExprContext extends ExpressionContext {
	...
	public OP_MAX(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_MAX, 0); }
	public OP_MIN(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_MIN, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class ComparisonExprContext extends ExpressionContext {
	...
	public OP_GT(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_GT, 0); }
	public OP_GE(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_GE, 0); }
	public OP_LT(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_LT, 0); }
	public OP_LE(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_LE, 0); }
	public OP_EQ(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_EQ, 0); }
	public OP_EQEQ(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_EQEQ, 0); }
	public OP_NE(): TerminalNode | undefined { return this.tryGetToken(SimCExprParser.OP_NE, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class AndExprContext extends ExpressionContext {
	...
	public OP_AND(): TerminalNode { return this.getToken(SimCExprParser.OP_AND, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class XorExprContext extends ExpressionContext {
	...
	public OP_XOR(): TerminalNode { return this.getToken(SimCExprParser.OP_XOR, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class OrExprContext extends ExpressionContext {
	...
	public OP_OR(): TerminalNode { return this.getToken(SimCExprParser.OP_OR, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class NumberExprContext extends ExpressionContext {
	public NUMBER(): TerminalNode { return this.getToken(SimCExprParser.NUMBER, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class StringExprContext extends ExpressionContext {
	public STRING(): TerminalNode { return this.getToken(SimCExprParser.STRING, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class MixedIdExprContext extends ExpressionContext {
	public MIXED_ID(): TerminalNode { return this.getToken(SimCExprParser.MIXED_ID, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
